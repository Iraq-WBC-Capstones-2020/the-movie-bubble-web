    ...
    <div className="about-content">
      ...
      >
        <div className="text-3xl flex flex-col justify-center items-center h-full">
          <p className="font-bold text-center">Don't get lost in the internet looking for a movie to watch, with us you can find it in a minute.</p>
      ...
      <div className="h-24 flex justify-center items-center">
        <p className="text-white bg-orange-600 px-4 py-2">All rights reserved © The Movie Bubble 2020</p>
      </div>
    </div>
  );
};
